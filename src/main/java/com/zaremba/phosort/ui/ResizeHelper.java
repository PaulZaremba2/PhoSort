...
public class ResizeHelper {
    ...
    public static void addResizeListener(Stage stage, HBox box) {
        ResizeListener resizeListener = new ResizeListener(stage, box);
    ...
    static class ResizeListener implements EventHandler<MouseEvent> {
        ...
        public ResizeListener(Stage stage, HBox box) {
            this.stage = stage;
            this.box = box;
        }
        ...
        public void handle(MouseEvent mouseEvent) {
            ...
            AnchorPane.setLeftAnchor(box, scene.getWidth() - 77);
        }
    }
}
